...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        //Handle enabled sources for access
        http.cors(cors -> cors.configurationSource(request -> {
            ...
            return config;
                ...
                //Handle ignore routes for authorization
                ...
                //Handle logouts
                .logout(logout -> logout.logoutUrl("/api/auth/logout").invalidateHttpSession(true).clearAuthentication(true).deleteCookies("JSESSIONID").logoutSuccessHandler((request, response, authentication) -> response.setStatus(200)));
